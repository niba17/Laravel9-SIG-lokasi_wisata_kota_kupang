...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('template') }}/login/css/my-login.css">
...
<body class="my-login-page">
        ...
        <div class="container h-100">
            <div class="row justify-content-md-center h-100">
                <div class="card-wrapper">
                    <div class="brand">
                        {{-- <img src="{{ asset('template') }}/login/img/logo.jpg" alt="logo"> --}}
                        <i class="fa-solid fa-user fa-3x" style="margin-left:27px;margin-top:23px;color:#0069D9;"></i>
                    </div>
                    <div class="card fat">
                        <div class="card-body">
                            ...
                            <form method="POST" action="/login">
                                ...
                                <div class="form-group">
                                    <label for="password">Password
                                        <a href="#" class="float-right" onclick="l_password()">
                                            Lupa Password?
                                        </a>
                                    </label>
                                    ...
                                    <div class="form-check mt-2">
                                        <input type="checkbox" class="form-check-input" id="checkbox"><label
                                            for="checkbox" class="p-0">Tampilkan
                                            password</label>
                                    </div>
                                </div>
    ...
    <script src="{{ asset('template') }}/login/js/my-login.js"></script>
